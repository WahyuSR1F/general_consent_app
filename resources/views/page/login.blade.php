...
<body class="bg-gradient-to-r from-green-800 to-green-500 flex items-center justify-center min-h-screen p-4">
    <div class="container bg-white p-8 rounded-lg shadow-md max-w-md w-full">
      ...
      <div class="text-center mb-3">
        <h5 class="text-green-900 font-bold">General Consent Puskesmas</h5>
        <h6 class="text-green-900 font-bold">Kabupaten Banyuwangi</h6>
      </div>
      <form action="{{ route('login_process') }}" method="post">
        ...
        <div class="flex justify-center">
          <button
          type="submit"
          class="w-full bg-green-600 text-white py-1 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 shadow-md hover:bg-green-800"onclick="window.location.href='./register.html'">Login</button>
        </div>
      </form>
    </div>
    </div>
