    ...
    <body class="bg-blue-900 flex items-center justify-center min-h-screen p-4">
        <div class="bg-gray-200 p-8 rounded-lg shadow-lg w-full max-w-5xl">
            <div class="w-full mb-5">
                 <h5 class="text-center text-5xl font-bold text-blue-900">Trimakasih Atas Persetujuan Consent</h5>
                <p class="text-center text-2xl font-bold text-blue-900 mt-2">Mohon klik selesai jika sudah, salam sehat</p>
            </div>
